    ...
    <section id="loop" ref={sectionRef} className="border-b border-border py-20 sm:py-28">
      <div className="container-hub">
        ...
        <div className="relative mt-16">
          <div className="absolute left-0 right-0 top-[1.35rem] hidden h-px bg-border lg:block" />
          <div
            ref={lineRef}
            className="absolute left-0 right-0 top-[1.35rem] hidden h-px scale-x-0 bg-primary lg:block"
          />
          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5 lg:gap-6">
            {steps.map((step, i) => (
              ...
              >
                <div
                  className={cn(
                    "flex h-11 w-11 items-center justify-center rounded-full border border-border bg-card text-muted-foreground transition-colors duration-300",
